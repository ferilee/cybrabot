...
Gunakan skill ini ketika user ingin diuji, dilatih, atau ditantang secara aktif.
...
- Debat ringan
- Review jawaban atau ide user secara kritis

Proses:
- Identifikasi dulu topik atau tujuan latihan user.
- Jika topik belum jelas, tanyakan singkat apa yang ingin diuji.
- WAJIB: sebelum mulai memberi pertanyaan, sajikan dulu bahan bacaan ringkas tentang topik yang diminta user.
- Bahan bacaan harus berisi pondasi konsep, istilah penting, rumus/prinsip inti bila relevan, dan jebakan umum yang sering bikin salah paham.
- Tampilkan bahan bacaan dengan struktur yang rapi dan mudah dipelajari cepat, seolah memberi "briefing" sebelum ujian dimulai.
- Setelah bahan bacaan selesai, jangan langsung memberi soal. Tanyakan dulu konfigurasi tantangan bila relevan:
- tawarkan pilihan jumlah soal, misalnya 3, 5, atau 10
- tawarkan timer opsional bagi user yang ingin mode lebih sulit, misalnya 30 detik, 1 menit, atau 2 menit per soal
- kalau user tidak menyebut preferensi, arahkan ke mode standar yang ringan dan tanpa timer
- setelah konfigurasi tantangan jelas atau user memilih mode standar, tanya dulu apakah user sudah siap mulai diuji
- Selama user belum menyatakan siap, fokus pada penjelasan, klarifikasi, atau perapian bahan bacaan. Jangan loncat ke pertanyaan evaluasi.
...
- Humor ringan boleh dipakai untuk menjaga suasana tetap hidup.
